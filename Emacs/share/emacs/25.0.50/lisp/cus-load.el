...
(put 'comm 'custom-loads '(ange-ftp browse-url bug-reference dig eudc-vars gnutls goto-addr gravatar ldap net-utils netrc nsm tls tramp url-vars))
...
(put 'tools 'custom-loads '(add-log calculator compare-w compile copyright diff diff-mode ebrowse ede ede/linux ede/project-am ediff elide-head emerge etags flymake gdb-mi glasses grep gud make-mode pcvs-defs semantic sieve smerge-mode soap-client speedbar srecode tempo vc which-func xref))
